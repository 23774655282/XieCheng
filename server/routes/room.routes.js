...
import { createRoom, getOwnerRooms, getOwnerRoomById, getRooms, getRoomById, toggleRoomAvailability, deleteRoom, updateRoom, updateRoomCount, updatePromoDiscount, smartSearchRooms, getRecommendationReasons, listRoomEditApplications, approveRoomEdit, rejectRoomEdit, listPendingRoomAdds, approveRoomAdd, rejectRoomAdd } from '../controllers/room.controller.js';
...
roomRouter.post("/recommendation-reasons", getRecommendationReasons);
...
roomRouter.get("/admin/pending-adds", authMiddleware, adminOnly, listPendingRoomAdds);
roomRouter.post("/admin/pending-adds/:id/approve", authMiddleware, adminOnly, approveRoomAdd);
roomRouter.post("/admin/pending-adds/:id/reject", authMiddleware, adminOnly, rejectRoomAdd);
